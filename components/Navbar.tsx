            ...
            <div className="relative" ref={cadastrosDropdownRef}>
              ...
              {cadastrosDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-gray-800 dark:bg-gray-700 rounded-md shadow-lg z-20" onClick={() => setCadastrosDropdownOpen(false)}>
                  <Link href="/cadastros/projetos" className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">Projetos</Link>
            ...
            <div>
                ...
                {adminMobileOpen && (
                    <div className="pl-4 mt-1 space-y-1">
                        <Link href="/cadastros/projetos" onClick={() => setMobileMenuOpen(false)} className="block px-3 py-2 rounded-md text-base font-medium text-gray-400 hover:bg-gray-700 hover:text-white">Projetos</Link>
