  ...
  return (
    <div>
      <div className="mb-4">
        ...
        <select onChange={(e) => setUserId(e.target.value)} className="mt-1 block w-full md:w-1/3 p-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 dark:text-white">
